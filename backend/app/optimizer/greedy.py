...
def _minimal_shift_cover(
    shifts: List[ShiftInfo], apertura: int, cierre: int
) -> List[ShiftInfo]:
    """
    ...
    """
    candidates = [s for s in shifts if s.inicio_min < cierre and s.fin_min > apertura]
...
def solve_greedy(
    ...
    dias_max_semana: int = params["dias_maximos_consecutivos"]
    ...
    for day in open_days:
        ...
        needed = _minimal_shift_cover(shifts, day.apertura_min, day.cierre_min)
        ...
        for shift in needed:
            eligible = [
                ...
                and horas_semana[wix][wi] + shift.duracion_h <= horas_max
            ...
            horas_semana[best_wix][wi] += shift.duracion_h
