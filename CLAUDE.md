...
|----|---------|--------|------|
| F1 | Supervisores como entidad central (reemplaza jefes de sucursal) | Pendiente | `v4/specs/F1-supervisores/` |
| F2 | Bloqueo de vendedores por rango de fechas | Pendiente | `v4/specs/F2-bloqueos/` |
