...
- [ ] Auditar jefes/supervisores sin email o password.
...
- [ ] Agregar smoke visual/manual para tabs: mensual, vendedor, cobertura dia.
...
- [ ] Validar sucursal sin categoria.
...
- [ ] Mostrar mensaje final despues de guardar con nombre de sucursal/grupo.
...
- [ ] Implementar exportacion de grupo como Excel multi-hoja.
- [x] Ocultar o deshabilitar botones de exportacion no implementados.
- [ ] Agregar mensaje si se intenta exportar calendario con errores bloqueantes.
- [ ] Validar nombre de archivo con sucursal/grupo, mes y anio.
...
- [ ] Crear modal/pagina "Como usar el calendario".
- [ ] Agregar contacto o instruccion de soporte ante errores.
...
- [ ] Registrar validaciones bloqueantes al intentar guardar.
- [ ] Mostrar en historial si el cambio afecto sucursal individual o grupo.

## Fase 9: Pruebas minimas

- [ ] Agregar tests unitarios para generacion de calendario.
- [ ] Agregar tests unitarios para split/merge de grupos por equipo.
- [x] Agregar tests unitarios para validaciones de calendario.
- [ ] Agregar smoke test de API `/api/calendars`.
- [ ] Agregar smoke test de acceso supervisor sin permisos.
...
- [ ] Definir procedimiento de rollback si el calendario queda inconsistente.

## Fase 11: Registro de cambios y reversibilidad

- [x] Crear `implementation-log.md` para documentar cambios F6 por entrega.
- [ ] Registrar cada nueva entrega F6 con archivos tocados, verificacion y reversion sugerida.
