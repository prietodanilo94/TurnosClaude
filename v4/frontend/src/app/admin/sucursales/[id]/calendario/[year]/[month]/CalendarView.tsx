...
import { validateCalendarForPublish, type CalendarValidationResult } from "@/lib/calendar/validation";
...
function CalendarValidationPanel({ validation }: { validation: CalendarValidationResult }) {
...
function buildValidationSummary(validation: CalendarValidationResult) {
  return {
        ...
        {activeSlots.map(({ slot, shift, workerId, att }) => {
          ...
          return (
            <div key={slot.slotNumber} className="flex items-center gap-2">
              ...
              <div className="flex-1 relative h-10 bg-white rounded border border-gray-200">
                {hourMarks.map((h) => (
                  <div
                    key={h}
                ...
                {[
                  ...
                  return (
                    ...
                    >
                      <span className={`text-[10px] font-bold leading-none mt-0.5 whitespace-nowrap bg-white/95 border rounded px-0.5 ${
