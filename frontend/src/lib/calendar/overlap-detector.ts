...
/**
 * Detecta solapamientos horarios entre slots del mismo trabajador en el mismo día.
 * Dos turnos se solapan si sus rangos [inicio, fin) se intersecan.
 */
export function detectOverlaps(
  ...
  for (const s of shiftCatalog) shiftMap[s.id] = s;

  // Agrupar por (worker_rut, date)
...
/** Devuelve el conjunto de assignment IDs que participan en al menos un solapamiento. */
