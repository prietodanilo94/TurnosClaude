...
const SHIFTS: SeedShift[] = [
  ...
  // ─── V_AP (Ventas Mall Autopark) ────────────────────────
  {
    id: "V_AP_APE",
    rotation_group: "V_AP",
    nombre_turno: "turno_1",
    nombre_display: "Turno 1",
    horario_por_dia: {
      martes: { inicio: "09:30", fin: "19:00" },
      miercoles: { inicio: "09:30", fin: "19:00" },
      jueves: { inicio: "09:30", fin: "19:00" },
      viernes: { inicio: "09:30", fin: "19:00" },
      sabado: { inicio: "10:00", fin: "19:00" },
    },
    descuenta_colacion: true,
    dias_aplicables: ["martes", "miercoles", "jueves", "viernes", "sabado"],
  },
  {
    id: "V_AP_CIE",
    rotation_group: "V_AP",
    nombre_turno: "turno_2",
    nombre_display: "Turno 2",
    horario_por_dia: {
      lunes: { inicio: "09:30", fin: "19:00" },
      martes: { inicio: "09:30", fin: "19:00" },
      miercoles: { inicio: "09:30", fin: "19:00" },
      viernes: { inicio: "09:30", fin: "19:00" },
      sabado: { inicio: "10:00", fin: "19:00" },
    ...
    descuenta_colacion: true,
    dias_aplicables: ["lunes", "martes", "miercoles", "viernes", "sabado"],
  },
